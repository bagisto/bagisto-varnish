...
return [
    'configuration' => [
        'cache-management' => [
            'title' => 'Gestió de la memòria cau',
            'info' => 'Gestioneu la memòria cau de l\'aplicació, esborreu o reconstruïu les dades emmagatzemades per a la configuració, rutes, vistes i més.',
        ],
